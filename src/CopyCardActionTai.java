...
//        System.out.println("Copied successfully.");
    ...
    void execute(Game game, PlayerPoker player, int source, int target)  {
        ...
        System.out.println("Select source index:" +source);


        System.out.println("Select target index:" + target);
